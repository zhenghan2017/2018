...
public class SocketManager
{
    ...
    /// <returns></returns>
    private sSocketData BytesToSocketData(ushort _protocalType, byte[] _data)
    {
    ...
    /// <param name="_data"></param>
    /// <returns></returns>
    private byte[] DataToBytes(ushort _protocalType, byte[] _data)
    {
    ...
    /// <param name="_protocalType"></param>
    /// <param name="_data"></param>
    private void SendMsgBase(ushort _protocalType, byte[] _data)
    {
        if (clientSocket == null || !clientSocket.Connected)
        {
            _ReConnect();
    ...
    /// <summary>
    /// 以ProtoBuf方式发送 游戏中的协议
    /// </summary>
    /// <param name="_protocalType"></param>
    /// <param name="data"></param>
    public void SendMsg(GameLogicPro _protocalType, ProtoBuf.IExtensible data)
    {
