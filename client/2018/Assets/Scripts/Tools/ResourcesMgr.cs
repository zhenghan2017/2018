...
namespace Tool
{
    public class ResourcesMgr : MonoBehaviour
    {
        ...
        /// <param name="isCatch"></param>
        /// <returns></returns>
        public List<GameObject> LoadAsset(List<string> pathList, bool isCatch)
        {
            List<GameObject> goObjcCloneList = new List<GameObject>();

            foreach(var path in pathList)
            {
                goObjcCloneList.Add(LoadAsset(path, isCatch));
            }

            return goObjcCloneList;
        }
